...
router.put('/:id', canReceptionistEdit, upload.array('files', 20), appointmentController.update);
router.delete('/:id/files/:fileId', canReceptionistDelete, appointmentController.removeFile);
router.delete('/:id', canReceptionistDelete, appointmentController.remove);
